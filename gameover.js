var gameover = {
    ...
    create: function(){
         ...
         var text = game.add.text(game.world.centerX, game.world.centerY - 110, "Game Over");
         if (points.toString() == -1){
             var textpoints = game.add.text(game.world.centerX, game.world.centerY - 85, "Points: 0");
         }else{
             var textpoints = game.add.text(game.world.centerX, game.world.centerY - 85, "Points: "+ points.toString());
         }
